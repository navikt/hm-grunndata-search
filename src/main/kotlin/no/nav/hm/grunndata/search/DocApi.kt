...
class DocApi(private val searchService: SearchService) {
    ...
    fun getProductById(params: Map<String, String>?, id: String): HttpResponse<String> {
        ...
        return HttpResponse.ok(searchService.lookupWithQuery(SearchService.PRODUCTS, params?: emptyMap(), id))
    ...
    fun searchAgreementWithQuery(params: Map<String, String>?, id: String): HttpResponse<String> {
        ...
        return HttpResponse.ok(searchService.lookupWithQuery(SearchService.AGREEMENTS, params?: emptyMap(), id))
            .header(CACHE_CONTROL, "public, immutable, max-age=300")
    }
    ...
    fun searchSupplierWithQuery(params: Map<String, String>?, id:String): HttpResponse<String> {
        ...
        return HttpResponse.ok(searchService.lookupWithQuery(SearchService.SUPPLIERS, params?: emptyMap(),id))
            .header(CACHE_CONTROL, "public, immutable, max-age=300")
    }
    ...
    fun searchNewsWithQuery(params: Map<String, String>?, id:String): HttpResponse<String> {
        ...
        return HttpResponse.ok(searchService.lookupWithQuery(SearchService.NEWS, params?: emptyMap(),id))
            .header(CACHE_CONTROL, "public, immutable, max-age=300")
    }
}
